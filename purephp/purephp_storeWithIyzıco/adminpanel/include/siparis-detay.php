                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td width="170"><?php
                                    ...
                                    ?>
                                    <?=$adsoyad?><br><?=$uyebilgisi[0]["adres"]?></td>
                                ...
                                <td>
                                    ...
                                    <form action="#" method="post">
                                        ...
                                        <select name="odemedurum" class="form-control select2">
                                            <option value="1" <?php if ($siparisler[0]["odemetipi"]==1){echo 'selected="selected"';} ?>>Ödendi</option>
                                            <option value="2" <?php if ($siparisler[0]["durum"]==2){echo 'selected="selected"';} ?>>Ödeme Bekliyor</option>
                                        </select>
                                        <input class="btn btn-primary btn-sm" type="submit" name="ilet" value="Güncelle">
                                    </form>
                                </td>
                                <td>
                                    <?php
                                    ...
                                    <form action="#" method="post">
                                        ...
                                        <select name="kargoadi" class="form-control select2">
                                        ...
                                        <input class="form-control" type="text" name="takipno" value="<?=$siparisler[0]["takipno"]?>" placeholder="Takip No">
                                        <input class="btn btn-primary btn-sm" type="submit" name="ilet" value="Güncelle">
                                    </form>
                                </td>
