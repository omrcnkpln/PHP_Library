<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Kargo Limit Ekle</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?=SITE?>">Anasayfa</a></li>
                        <li class="breadcrumb-item active">Kargo Limit Ekle</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            if($_POST)
            {
                if(!empty($_POST["baslik"]))
                {
                    ...
                    $ekle=$VT->SorguCalistir("INSERT INTO kargolimit","SET baslik=?, sinir=?, kargotutar=?, durum=?, tarih=?",array($baslik,$sinir,$kargotutar,1,date("Y-m-d")));
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Kargo Limit Başlık Giriniz ..." name="baslik">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Hangi Tutara Kadar</label>
                                    <input type="text" class="form-control" placeholder="Hangi Tutara Kadar" name="sinir">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Kaç TL Kargo Ödenecek</label>
                                    <input type="text" class="form-control" placeholder="Kaç TL Kargo Ödenecek..." name="kargotutar">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
