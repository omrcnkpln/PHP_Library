<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Kupon Ekle</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            ...
            if($_POST)
            {
                if(!empty($_POST["kod"]))
                {
                    ...
                    $ekle=$VT->SorguCalistir("INSERT INTO kuponlar","SET kod=?, yuzde=?, adet=?, sure=?, durum=?, tarih=?",array($kod,$yuzde,$adet,$sure,1,date("Y-m-d")));
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Kupon Kodu ..." name="kod">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>İndirim Oranı(%)</label>
                                    <input type="text" class="form-control" placeholder="İndirim Oranı(%)" name="yuzde">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Kaç Kere Kullanılacak</label>
                                    <input type="text" class="form-control" placeholder="Adet Olarak Yazınız..." name="adet">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Hangi Tarihe Kadar</label>
                                    <input type="date" class="form-control" name="sure">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
