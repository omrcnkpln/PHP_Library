...
class VT{
	...
	var $user="demothinkermathc_yeni";
	var $password="asus123654.*";
	var $dbname="demothinkermathc_yeni";
	var $baglanti;
  ...
  PRIMARY KEY (`ID`)
	...
	*/
    ...
    public function MailGonder($mail,$konu="",$mesaj)
    {
        ...
        $posta->Host = "ni-sofia.guzelhosting.com"; // SMTP servers
        $posta->SMTPAuth = true;     // turn on SMTP authentication
        $posta->Username = "canerturker@turkermedya.com";  // SMTP username
        $posta->Password = "caner1453."; // SMTP password
        $posta->Port = 465;
        $posta->From = "canerturker@turkermedya.com"; // smtp kullanýcý adýnýz ile ayný olmalý
        $posta->Fromname = "canerturker@turkermedya.com";
        $posta->AddAddress($mail, "canerturker@turkermedya.com");
        $posta->Subject = $konu;
        $posta->Body = $mesaj;
