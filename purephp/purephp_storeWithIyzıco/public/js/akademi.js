...
// <!-- _____________________________ yazÄ±larÄ±n hareketi _____________________________________________________________ -->
...
function changeHeaderBg() {
    if (i == 0) {
        $header.removeClass().addClass("bg-4 akademi-slider");
    } else if (i == 1) {
        $header.removeClass().addClass("bg-5 akademi-slider");
    } else if (i == 2) {
        $header.removeClass().addClass("bg-1 akademi-slider");
    } else if (i == 3) {
        $header.removeClass().addClass("bg-2 akademi-slider");
    } else if (i == 4) {
        $header.removeClass().addClass("bg-3 akademi-slider");
    }
}
