...
(function( $, window, document, undefined ) {
	...
	var DataTable = function ( options )
	{
		...
		this.each(function() {
			...
			/* Backwards compatibility for the default */
			_fnCompatOpts( defaults );
			_fnCompatCols( defaults.column );

			/* Convert the camel-case default to Hungarian */
			...
			// Apply the default and init options to make a single init object will all
			// options defined from default and instance options.
	...
	DataTable.defaults = {
		 ...
		 *   default, or you can add the items to the object that was passed in and
	...
	/*
	 * Developer note - See note in model.default.js about the use of Hungarian
