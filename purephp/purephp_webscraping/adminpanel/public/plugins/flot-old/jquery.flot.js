...
(function($) {
    ...
    function Plot(placeholder, data_, options_, plugins) {
        ...
        function parseOptions(opts) {
            ...
            // end up with those colors plus the remaining default, which is
            ...
            // Fill in default for axis options, including any unspecified
        ...
        function drawAxisLabels() {
            ...
            $.each(allAxes(), function (_, axis) {
                ...
                // tick labels will end up with both theirs and the default.
