...
var Buttons = function( dt, config )
{
	...
	// Allow a boolean true for default
	if ( config === true ) {
		config = {};
	}
...
$.extend( Buttons.prototype, {
	...
	_popover: function ( content, hostButton, inOpts ) {
		...
		if ( position === 'absolute' ) {
			...
			// $.fn.dataTable.Buttons.default.dom.collection.className += " dropdown-menu-right";
...
/**
 * Buttons default. For full documentation, please refer to the docs/option
